...
struct _CfgBlockGenerator
{
  ...
  gboolean (*generate)(CfgBlockGenerator *self, GlobalConfig *cfg, CfgArgs *args, GString *result, const gchar *reference);
...
gboolean cfg_block_generator_generate(CfgBlockGenerator *self, GlobalConfig *cfg, CfgArgs *args, GString *result, const gchar *reference);
